<div class="" >
    <div class="modal fade " id="editItemCategoryModal" wire:ignore.self>
        <div class="modal-dialog modal-lg">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editStallModalLabel">Edit Item Category</h5>
...
@script
<script>
    $wire.on('show-edit-item-category-modal', () => {
        $('#editItemCategoryModal').modal('show');
    });
    $wire.on('hide-edit-item-category-modal', () => {
