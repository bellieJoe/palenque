<div class="" >
    <button class="btn btn-primary" wire:click="showCreateStallRateModal">Add Stall Rate</button>
    <div class="modal fade " id="createStallRateModal" wire:ignore.self>
        <div class="modal-dialog modal-lg">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createStallModalLabel">Add Stall Rate</h5>
...
@script
<script>
    $wire.on('show-create-stall-rate-modal', () => {
        $('#createStallRateModal').modal('show');
    });
    $wire.on('hide-create-stall-rate-modal', () => {
        $('#createStallRateModal').modal('hide');
    });
</script>
@endscript
