<div>
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="card-title">Edit Violation Type</h6>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="d-flex justify-content-end ">
                ...
                <button type="button" class="btn btn-primary ml-2" wire:click="saveViolationType" wire:loading.attr="disabled">Save Violation Type</button>
            </div>
        </div>
    </div>
</div>
