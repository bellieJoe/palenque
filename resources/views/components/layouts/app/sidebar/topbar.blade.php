            ...
            <div class="navbar-brand">
                <a href="index.html" class="logo">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{ asset('logo/logo-icon-30.png') }}" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="{{ asset('logo/logo-icon-30.png') }}" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="{{ asset('logo/logo-text-30.png') }}" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                        <img src="{{ asset('logo/logo-text-30.png') }}" class="light-logo" alt="homepage" />
                    </span>
                </a>
                ...
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY" >
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            <div class="">
                                <img src="https://api.dicebear.com/9.x/identicon/svg?seed={{ auth()->user()->name }}" alt="user" class="rounded-circle" width="60">
                            </div>
                            <div class="m-l-10">
                        ...
                        <div class="profile-dis scrollable">
                            <a class="dropdown-item" href="{{ route('settings.profile') }}" wire:navigate><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
